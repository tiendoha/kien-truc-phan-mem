package com.system.order_container.rest.dto;
...
@AllArgsConstructor
@Builder
@Schema(description = "REST request to process payment for an order")
public class RestOrderPaymentRequest {
    ...
    public OrderPaymentRequest toOrderPaymentRequest() {
        return OrderPaymentRequest.builder()
