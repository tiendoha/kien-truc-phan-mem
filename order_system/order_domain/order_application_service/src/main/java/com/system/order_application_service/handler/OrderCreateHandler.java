...
public class OrderCreateHandler {
    ...
    private final OrderCreatedPaymentRequestMessagePublisher paymentRequestPublisher;
    public OrderCreateHandler(OrderRepository orderRepository, VoucherServicePort voucherServicePort, OrderCreatedPaymentRequestMessagePublisher publisher) {
        ...
        this.paymentRequestPublisher = Objects.requireNonNull(publisher, "Publisher cannot be null");
    }
    ...
    public OrderResponse createOrder(CreateOrderRequest request) {
        ...
        paymentRequestPublisher.publish(savedOrder);
